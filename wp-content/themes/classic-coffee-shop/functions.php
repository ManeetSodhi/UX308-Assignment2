...
if (!function_exists('classic_coffee_shop_loop_columns')) {
    function classic_coffee_shop_loop_columns() {
        $colm = get_theme_mod('classic_coffee_shop_products_per_row', 4); // Default to 4 if not set
        return $colm;
    }
}
...
function classic_coffee_shop_setup_theme() {
	...
	if ( ! defined( 'CLASSIC_COFFEE_SHOP_BUNDLE_PAGE' ) ) {
		define('CLASSIC_COFFEE_SHOP_BUNDLE_PAGE',__('https://www.theclassictemplates.com/products/wordpress-theme-bundle','classic-coffee-shop'));
	}
	// Footer Link
    ...
    if ( !$classic_coffee_shop_dismissed) { ?>
        <div class="getstrat updated notice notice-success is-dismissible notice-get-started-class">
            ...
            <div class="admin-content" >
				...
				printf( esc_html__( 'Welcome to %1$s %2$s', 'classic-coffee-shop' ), esc_html($classic_coffee_shop_theme->get( 'Name' )), esc_html($classic_coffee_shop_theme->get( 'Version' ))); ?>
                </h1>
			...
			<div class="admin-bundle-image">
				<a href="<?php echo esc_url( CLASSIC_COFFEE_SHOP_BUNDLE_PAGE ); ?>" target="_blank"><img src="<?php echo esc_url(get_stylesheet_directory_uri()) .'/images/image_1.webp'; ?>" /></a>
			</div>
        </div>
    <?php }
}