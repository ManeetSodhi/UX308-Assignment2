...
function classic_coffee_shop_customize_register( $wp_customize ) {
	...
	// Enable / Disable Logo
	$wp_customize->add_setting('classic_coffee_shop_logo_enable',array(
		'default' => true,
		'sanitize_callback' => 'classic_coffee_shop_sanitize_checkbox',
	));
	$wp_customize->add_control( 'classic_coffee_shop_logo_enable', array(
		'settings' => 'classic_coffee_shop_logo_enable',
		'section'   => 'title_tagline',
		'label'     => __('Enable Logo','classic-coffee-shop'),
		'type'      => 'checkbox'
	));
   ...
   $wp_customize->add_control('classic_coffee_shop_products_per_page', array(
    ...
    // Menu Text Transform
    $wp_customize->add_setting( 'classic_coffee_shop_menu_text_transform', array(
        'default'           => 'Capitalize',
		'transport' => 'refresh',
		'sanitize_callback' => 'classic_coffee_shop_sanitize_choices'
    ));

    $wp_customize->add_control( 'classic_coffee_shop_menu_text_transform', array(
        'label'    => __( 'Menu Text Transform', 'classic-coffee-shop' ),
        'section'  => 'classic_coffee_shop_links_section',
        'type'     => 'select',
        'choices'  => array(
			'None'       => __( 'None', 'classic-coffee-shop' ),
            'Capitalize' => __( 'Capitalize', 'classic-coffee-shop' ),
            'Uppercase'  => __( 'Uppercase', 'classic-coffee-shop' ),
            'Lowercase'  => __( 'Lowercase', 'classic-coffee-shop' ),
        ),
    ));
   ...
   // Add Settings and Controls for Post Layout
	...
	//Page Settings
	$wp_customize->add_section('classic_coffee_shop_page_settings',array(
		'title' => __('Manage Page Section', 'classic-coffee-shop'),
		'priority' => null,
		'panel' => 'classic_coffee_shop_panel_area'
	));
	...
	$wp_customize->add_control('classic_coffee_shop_sidebar_page_layout',array(
		'type' => 'radio',
		'label'     => __('Theme Page Sidebar Position', 'classic-coffee-shop'),
		'section' => 'classic_coffee_shop_page_settings',
		'choices' => array(
			'left' => __('Left','classic-coffee-shop'),
			'right' => __('Right','classic-coffee-shop'),
			'full' => __('No Sidebar','classic-coffee-shop')
	...
	$wp_customize->add_setting( 'classic_coffee_shop_page_settings_upgraded_features',array(
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('classic_coffee_shop_page_settings_upgraded_features', array(
		'type'=> 'hidden',
		'description' => "<span class='customizer-upgraded-features'>Unlock Premium Customization Features:
		   <a target='_blank' href='". esc_url(CLASSIC_COFFEE_SHOP_PREMIUM_PAGE) ." '>Upgrade to Pro</a></span>",
		'section' => 'classic_coffee_shop_page_settings'
	...
	$wp_customize->add_setting('classic_coffee_shop_page_not_found_btn',array(
		'default' => 'Homepage',
		'sanitize_callback' => 'sanitize_text_field',
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_control( 'classic_coffee_shop_page_not_found_btn', array(
	   'settings' => 'classic_coffee_shop_page_not_found_btn',
	   'section'   => 'classic_coffee_shop_page_not_found',
	   'label' => __('404 Button', 'classic-coffee-shop'),
	   'type'      => 'text'
	));
	...
	$wp_customize->add_setting('classic_coffee_shop_footer_img_position',array(
		'default' => 'center center',
		'transport' => 'refresh',
		'sanitize_callback' => 'classic_coffee_shop_sanitize_choices'
	));
	$wp_customize->add_control('classic_coffee_shop_footer_img_position',array(
		'type' => 'select',
		'label' => __('Footer Image Position','classic-coffee-shop'),
		'section' => 'classic_coffee_shop_footer',
		'choices' 	=> array(
			'center center'   => esc_html__( 'Center', 'classic-coffee-shop' ),
			'center top'   => esc_html__( 'Top', 'classic-coffee-shop' ),
			'left center'   => esc_html__( 'Left', 'classic-coffee-shop' ),
			'right center'   => esc_html__( 'Right', 'classic-coffee-shop' ),
			'center bottom'   => esc_html__( 'Bottom', 'classic-coffee-shop' ),
		),
	));	
