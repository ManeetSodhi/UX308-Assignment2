...
<div class="col-lg-4 col-md-6 postsec-list grid">
    ...
    <div class="listarticle">
        ...
        <header class="entry-header">
            ...
            <?php if ('post' == get_post_type() && ( get_theme_mod('classic_coffee_shop_metafields_date', true) || get_theme_mod('classic_coffee_shop_metafields_comments', true) || get_theme_mod('classic_coffee_shop_metafields_author', true) || get_theme_mod('classic_coffee_shop_metafields_time', true))) : ?>
                <div class="postmeta">
