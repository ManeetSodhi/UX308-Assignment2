    ...
    <div id="content" class="contentsecwrap">
        <section class="site-main page-not-found">
            ...
            <div class="page-content">
                ...
                <?php if( get_theme_mod('classic_coffee_shop_page_not_found_btn','Homepage') != ''){ ?>
                    <div class="not-found-btn mt-3 mb-4 mx-0">
                        <a href="<?php echo esc_url( home_url() ); ?>" class="button py-2 px-3"><?php echo esc_html(get_theme_mod('classic_coffee_shop_page_not_found_btn',__('Homepage','classic-coffee-shop')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('classic_coffee_shop_page_not_found_btn',__('Homepage','classic-coffee-shop')));?></span></a>
                    </div>
                <?php } ?>
            </div>
        </section>
