...
<?php if ( get_theme_mod('classic_coffee_shop_preloader',false) != "") { ?>
  <div id="preloader">
    <div id="status">&nbsp;</div>
  </div>
<?php }?>
      ...
      <div class="row m-0">
        <div class="col-12 col-md-5 col-lg-12 p-0 align-self-center">
          <div class="logo text-center py-5 py-md-2 py-lg-5">
            <?php if (get_theme_mod('classic_coffee_shop_logo_enable', true)) { ?>
            ...
            <?php if ( ! empty( $classic_coffee_shop_blog_info ) ) : ?>
              <?php if ( get_theme_mod('classic_coffee_shop_title_enable',false) != "") { ?>
        ...
        <?php if ( get_theme_mod('classic_coffee_shop_social_media', 'true') != "") { ?>
